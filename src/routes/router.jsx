...
import TermsPageSkeleton from "../components/common/skeletons/TermsPageSkeleton";
...
const Terms = Loadable(lazy(() => import("../pages/public/Terms/Terms")), <TermsPageSkeleton />);
