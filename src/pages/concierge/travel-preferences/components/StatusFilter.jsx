  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex min-w-[120px] items-center justify-between gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2 text-xs font-medium text-gray-700 shadow-sm transition-colors hover:border-gray-300"
      >
        {selectedLabel}
