...
//       <div className="relative mx-auto flex h-16 container items-center justify-between px-4 sm:px-6">
        ...
        <div className="hidden lg:flex items-center justify-end gap-3 w-[220px] flex-shrink-0">
          {isAuthenticated ? (
            ...
            <>
              ...
              <Link
                to="/login"
                className="rounded-full bg-[#10336A] px-5 py-2.5 text-sm font-medium text-white hover:bg-opacity-90 transition-colors whitespace-nowrap"
              >
                Log In
              </Link>
            </>
